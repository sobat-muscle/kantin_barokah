...
class Model_products extends CI_Model
{
	...
	public function StoresJoin($id = null)
	{
		$this->db->select('products.*', 'stores.name as store_name');
	...
	public function countProducts($id = null)
	{
		if ($id) {
			$sql = "SELECT * FROM products where id = ?";
			$query = $this->db->query($sql, array($id));
	...
	public function get_by_stores_product()
  {
      $this->db->select('
          products.*, stores.name as stores_name, stores.name
      ');
