          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
            <div class="box-body">
              ...
              <div class="col-md-6 col-xs-12 pull pull-right">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label">Jumlah Kotor</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label for="net_amount" class="col-sm-5 control-label">Jumlah Akhir</label>
                  <div class="col-sm-7">
...
<script type="text/javascript">
  ...
  //get the stores information from the server
  function getStoreData(row_id) {
    var stores_id = $("#store_" + row_id).val();
  }
