        ...
        <div class="box">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="price">Profit Share</label>
                <input type="text" class="form-control" id="prft_shr" name="prft_shr" placeholder="Enter profit share" autocomplete="off" value="<?php echo $this->input->post('prft_shr') ?>" />
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control select_group" id="store" name="store[]" multiple="multiple">
                  <?php foreach ($stores as $k => $v) : ?>
                    <option value="<?php echo $v['id'] ?>" <?php if (in_array($v['id'], $store_data)) {
                                                                echo 'selected="selected"';
                                                              } ?>><?php echo $v['name'] ?></option>
                  <?php endforeach ?>
                </select>
